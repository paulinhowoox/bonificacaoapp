...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('manager/assets/images/favicon.png') }}">
    <title>CMS | Bonificação App </title>
    <!-- Custom CSS -->
    <link href="{{ asset('manager/dist/css/style.min.css') }}" rel="stylesheet">
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" class="form-control form-control-lg @error('password') is-invalid @enderror" placeholder="Senha" aria-label="Senha" aria-describedby="basic-addon1" name="password" required autocomplete="current-password">
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                ...
                <div id="recoverform">
                    <div class="text-center">
                        <span class="text-white">Nós enviaremos um link de redefição de senha para o email cadastrado em nosso sistema.</span>
                    </div>
                    <div class="row m-t-20">
                        ...
                        <form class="col-12" action="{{ route('password.email') }}" method="POST">
                            ...
                            <div class="row m-t-20 p-t-20 border-top border-secondary">
                                <div class="col-12">
                                    <a class="btn btn-success" href="#" id="to-login" name="action">Voltar para o Login</a>
